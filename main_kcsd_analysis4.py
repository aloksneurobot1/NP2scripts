...
https://github.com/NeuralEnsemble/elephant/tree/master/elephant/current_source_density_src

@author: Alok adapted from Elephant csd codes for KCSD1D
"""
import numpy as np
import pandas as pd
...
OUTPUT_DIR = Path("./csd_kcsd_output_epoch_f32_v4_fixed_params_v2") 
...
CSD_CONDUCTIVITY = 0.3  # Siemens per meter (S/m) -> will be passed as 'sigma'
            ...
            for i_shank, shank_id_val in enumerate(unique_shanks):
                ...
                try: 
                    ...
                    kcsd_estimator_obj = estimate_csd(
                        ...
                        method='KCSD1D', # CORRECTED: Uppercase K
