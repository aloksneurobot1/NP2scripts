...
# --- PLOTTING CHANGE: This function now returns more data for the new plots ---
def deconvolve_and_analyze(
    ...
    """Performs CCH deconvolution and returns all necessary data for analysis and plotting."""
    ...
    return {
        ...
        "acg_pre": acg_pre,
        "acg_post": acg_post,
        "deconvolved_cch": deconvolved_cch,
        "predictor": predictor,
        "significant_peaks": significant_peaks
    }

# --- PLOTTING CHANGE: This function is completely redesigned for the new plots ---
def plot_deconvolution_results(results, epoch_idx, pre_id, post_id, output_dir):
    """Creates a detailed, two-panel plot with inset auto-correlograms."""
    import matplotlib.pyplot as plt
    fig, (ax1, ax2) = plt.subplots(2, 1, figsize=(8, 10), sharex=True)
    fig.suptitle(f'Interaction Analysis: Epoch {epoch_idx}\n{pre_id} (Pre) -> {post_id} (Post)', fontsize=14)
    
    # --- Panel 1: Raw Cross-Correlogram with Inset Auto-Correlograms ---
    ...
    # Inset for Presynaptic ACH
    ax_inset_pre = ax1.inset_axes([0.02, 0.65, 0.25, 0.3]) # [x, y, width, height]
    ...
    # --- Panel 2: Deconvolved CCH and Predictor ---
...
# =============================================================================
# --- PARALLEL WORKER AND MAIN WORKFLOW (UNCHANGED) ---
# =============================================================================
